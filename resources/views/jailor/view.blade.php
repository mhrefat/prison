...
<div class="container bootstrap snippet">
    ...
    <div class="row">
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item text-right"><span class="pull-left"><strong>Jailor Name</strong></span> {{ $jailor->jailor_name}}</li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>Email</strong></span>  {{ $jailor->email}}</li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>Age</strong></span>  {{ $jailor->age}}</li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>Address</strong></span> {{ $jailor->address}}</li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>gender</strong></span> {{ $jailor->gender}}</li>
