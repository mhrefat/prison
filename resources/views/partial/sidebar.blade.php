...
<li class="nav-item">
    ...
    <div id="collapseTwin" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Custom Components:</h6>
            <a class="collapse-item" href="{{route('prisoner.form')}}">Add Prisoner</a>
            <a class="collapse-item" href="{{route('prisoner.list')}}">Prisoner List</a>
        </div>
    </div>
</li>

<!-- Nav Item - Pages Collapse Menu (Visitor) -->
<li class="nav-item">
    ...
    <div id="collapseTwice" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Custom Components:</h6>
            <a class="collapse-item" href="{{route('visitor.form')}}">Add Visitor</a>
            <a class="collapse-item" href="{{route('visitor.list')}}">Visitor List</a>
        </div>
    </div>
</li>
