...
<div class="container bootstrap snippet">
    ...
    <div class="row">
          ...
          <ul class="list-group">
            <li class="list-group-item text-muted">Prisoner Profile</li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>Prisoner Name</strong></span> {{ $prisoner->prisoner_name}}</li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>Crime</strong></span>  {{ $prisoner->crime}}</li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>Address</strong></span>  {{ $prisoner->address}}</li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>Punishment</strong></span> {{ $prisoner->punishment}}</li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>Age</strong></span> {{ $prisoner->age}}</li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>Gender</strong></span> {{ $prisoner->gender}}</li>
